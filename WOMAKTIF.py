...
FILE='/home/hercules/mfoutlist/WOMAKTIF'
# FILE='/home/miftah/mfoutlist/WOMAKTIF'
JCL="IMSVS.PROD.BMP(WOMAKTIF)"
...
PARAM_INTERVAL = "%s" % (end.strftime("%y%m%d"))
