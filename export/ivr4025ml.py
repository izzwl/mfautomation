...
for i,l in enumerate(lines):
    if i > 6:
        ...
        ws.write(row, col+3, l[14:22].strip(), font_style)
        ws.write(row, col+4, l[22:44].strip(), font_style)
        ws.write(row, col+5, l[44:81].strip(), font_style)
        ws.write(row, col+6, l[81:87].strip(), font_style)
        ws.write(row, col+7, l[87:93].strip(), font_style)
        ws.write(row, col+8, l[93:99].strip(), font_style)
        ws.write(row, col+9, l[99:117].strip(), font_style)
        ws.write(row, col+10, l[117:129].strip(), font_style)
        ws.write(row, col+11, l[129:150].strip(), font_style)
        ws.write(row, col+12, l[150:187].strip(), font_style)
