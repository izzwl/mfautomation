...
# outlist name
FILE        = os.path.join(OUTLIST_DIR,'LDB0102D-'+_param)

# jcl mainframe name
JCL         = "IMSVS.PROD.BMP.auto(LDB0102D)"
...
if runxls.lower() == 'y':
    ...
    sys.argv = [
        '',
        '--input=LDB0102D-'+_param,
        '--output=LDB0102D-'+_param+'.xls',
    ]
    # sys.argv = [sys.argv[0]]
    execfile(__file__)