...
# outlist name
# if is_runxls:
#     FILE        = os.path.join(OUTLIST_DIR,'PPB1300H-'+_param)
# else:
#     FILE        = os.path.join(OUTLIST_DIR,'PPB1300H')
FILE        = os.path.join(OUTLIST_DIR,'PPB1300H-'+_param)

# jcl mainframe name
JCL         = "IMSVS.PROD.BMP.LAMA(PPB1300H)"
...
sys.argv = ['','--input=PPB1300H-'+_param,'--output=PPB1300H-'+_param+'.xls']
# sys.argv = [sys.argv[0]]
execfile(__file__)