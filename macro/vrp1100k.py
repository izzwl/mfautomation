...
parser.add_argument('--param', help='210101 211231')
...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'VRP1100K-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'VRP1100K')


# jcl mainframe name
JCL         = "IMSVS.PROD.BMP(VRP1100K)"
...
if is_runxls:
    ...
    sys.argv = ['','--input=VRP1100K-'+_param,'--output=VRP1100K-'+_param+'.xls']
    # sys.argv = [sys.argv[0]]
    execfile(__file__)