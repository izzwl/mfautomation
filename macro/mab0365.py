...
parser.add_argument('--param', help='0444555')
...
# outlist name
FILE        = os.path.join(OUTLIST_DIR,'MAB0365-'+args.param)

# jcl mainframe name
JCL         = "IMSVS.PROD.BMP(MAB0365)"
...
os.chdir('export')
# sys.argv = [sys.argv[0],'--input='+FILE,'--output='+FILE]
sys.argv = ['','--input=MAB0365-'+param,'--output=MAB0365-'+param+'.xls']
# sys.argv = [sys.argv[0]]
execfile(__file__)