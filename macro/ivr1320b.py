...
parser.add_argument('--param', help='2203010000000 2203319999999')
...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1320B-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1320B')


# jcl mainframe name
JCL         = "IMSVS.PROD.BMP.AUTO(IVR1320B)"
...
if is_runxls:
    ...
    # sys.argv = [sys.argv[0]]
    sys.argv = ['','--input=IVR1320B-'+_param,'--output=IVR1320B-'+_param+'.xls']
    execfile(__file__)
