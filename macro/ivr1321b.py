...
parser.add_argument('--param', help='2203010000000 2203319999999 0')
...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1321B-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1321B')


# jcl mainframe name
JCL         = "IMSVS.PROD.BMP.AUTO(IVR1321B)"
...
if is_runxls:
    ...
    # sys.argv = [sys.argv[0]]
    sys.argv = ['','--input=IVR1321B-'+_param,'--output=IVR1321B-'+_param+'.xls']
    execfile(__file__)
