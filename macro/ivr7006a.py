...
parser.add_argument('--param', help='BP1400001 BP2099999')
...
# outlist name
FILE        = os.path.join(OUTLIST_DIR,'IVR7006A-'+_param)

# jcl mainframe name
JCL         = "IMSVS.PROD.BMP(IVR7006A)"
...
if runxls.lower() == 'y':
    ...
    sys.argv = ['','--input=IVR7006A-'+_param,'--output=IVR7006A-'+_param+'.xls']
    execfile(__file__)
