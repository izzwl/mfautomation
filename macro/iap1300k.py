...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'IAP1300K-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'IAP1300K')


# jcl mainframe name
JCL         = "IMSVS.PROD.BMP(IAP1300)"
...
if is_runxls:
    ...
    sys.argv = ['','--input=IAP1300K-'+_param,'--output=IAP1300K-'+_param+'.xls']
    # sys.argv = [sys.argv[0]]
    execfile(__file__)