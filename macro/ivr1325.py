...
parser.add_argument('--param', help='1801010000000 2109309999999 0')
...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1325-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1325')


# jcl mainframe name
JCL         = "IMSVS.PROD.BMP.AUTO(IVR1325)"
...
if is_runxls:
    ...
    # sys.argv = [sys.argv[0]]
    sys.argv = ['','--input=IVR1325-'+_param,'--output=IVR1325-'+_param+'.xls']
    execfile(__file__)
