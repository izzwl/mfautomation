...
parser.add_argument('--param', help='201001 201031 U3410 U3420 U3430 U3440 U3800 U3810')
...
# outlist name
FILE        = os.path.join(OUTLIST_DIR,args.output or 'LDB0105B')

# jcl mainframe name
JCL         = "IMSVS.PROD.BMP(LDB0105B)"
