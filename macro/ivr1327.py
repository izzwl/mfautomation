...
parser.add_argument('--param', help='1801010000000 2109309999999')
...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1327-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'IVR1327')


# jcl mainframe name
JCL         = "IMSVS.PROD.BMP(IVR1327)"
...
if is_runxls:
    ...
    # sys.argv = [sys.argv[0]]
    sys.argv = ['','--input=IVR1327-'+_param,'--output=IVR1327-'+_param+'.xls']
    execfile(__file__)
