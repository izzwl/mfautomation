...
parser.add_argument('--param', help='O POYYYYYY POZZZZZZ X')
...
# outlist name
FILE        = os.path.join(OUTLIST_DIR,'IVR7020H')

# jcl mainframe name
JCL         = "IMSVS.PROD.BMP.RUTIN(IVR7020H)"
...
output_filename = ""
if not args.param:
    output_filename = "%s - IVR7020H.xls" % (end.strftime("%Y.%m.%d"))
