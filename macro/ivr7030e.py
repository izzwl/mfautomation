...
parser.add_argument('--param', help='R1800001 R2099999 X X')
...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'IVR7030E-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'IVR7030E')


# jcl mainframe name
JCL         = "IMSVS.PROD.BMP.LAMA(IVR7030E)"
...
if is_runxls:
    ...
    sys.argv = ['','--input=IVR7030E-'+_param,'--output=IVR7030E-'+_param+'.xls']
    # sys.argv = [sys.argv[0]]
    execfile(__file__)
