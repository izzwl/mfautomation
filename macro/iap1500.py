...
# outlist name
if is_runxls:
    FILE        = os.path.join(OUTLIST_DIR,'IAP1500-'+_param)
else:
    FILE        = os.path.join(OUTLIST_DIR,'IAP1500')
...
if is_runxls:
    ...
    sys.argv = ['','--input=IAP1500-'+_param,'--output=IAP1500-'+_param+'.xls']
    # sys.argv = [sys.argv[0]]
    execfile(__file__)